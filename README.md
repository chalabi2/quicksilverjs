...
<p align="center">
  <img src="https://user-images.githubusercontent.com/545047/188804067-28e67e5e-0214-4449-ab04-2e0c564a6885.svg" width="80"><br />
    A JS library for the Quicksilver chain
</p>
...
const balance = await client.cosmos.bank.v1beta1
    .allBalances({ address: 'quicksilver1addresshere' });

// you can also query the quicksilver modules
const balances = await client.quicksilver.exchange.v1beta1
    .exchangeBalances()
```
...
const {
    ...
    deposit
} = quicksilver.exchange.v1beta1.MessageComposer.withTypeUrl;
```
